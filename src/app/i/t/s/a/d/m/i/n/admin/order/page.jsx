...
// FILE PATH: app/i/t/s/a/d/m/i/n/admin/orders/page.jsx
// ROUTE: /i/t/s/a/d/m/i/n/admin/orders
// 🟢 Ab poori tarah backend API se connected hai — dummyOrders, Statusstore,
// trashStore (sab localStorage-based) hata diye gaye hain.
...
// 🟢 Status config — ye sirf UI labels/colors hain (data nahi), backend enum se match karte hain
...
export default function OrdersPage() {
  ...
  const [trashTarget, setTrashTarget] = useState(null); // single order object, or "ALL"
  const [showChangeAllPopover, setShowChangeAllPopover] = useState(false);
  const [pendingBulkStatus, setPendingBulkStatus] = useState(null);

  // 🟢 Active (non-trashed) orders backend se fetch karo
