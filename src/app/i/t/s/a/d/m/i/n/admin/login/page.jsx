...
export default function AdminLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    // Automatic live server connection with a local backup option
    const BACKEND_URL = process.env.NEXT_PUBLIC_API_URL || 'https://vercel.app';
    ...
    try {
      ...
      setError('Cannot connect to live backend server. Please verify your connection!');
    }
  };
