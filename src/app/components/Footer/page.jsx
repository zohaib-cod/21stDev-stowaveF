...
// }) => {
//   return (
//     <section className="py-16 w-full bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 border-t border-zinc-200 dark:border-zinc-800">
...
//         <div className="mt-8 flex flex-col justify-between gap-4 border-t border-zinc-200 dark:border-zinc-800 py-8 text-xs font-medium text-zinc-400 dark:text-zinc-500 md:flex-row md:items-center md:text-left">
...
export const Footer7 = ({
  ...
  description = "Stowave Quality Wear Everyday.",
  socialLinks = defaultSocialLinks,
  copyright = "© 2025 Stowave.com. All rights reserved.",
  legalLinks = defaultLegalLinks,
}) => {
  return (
