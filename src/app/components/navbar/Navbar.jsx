...
//       // Agar token aur user context data dono available hon toh route filter pass karein
...
//     // Listeners apply karein takay Login/Signup submit hotay hi profile status real-time update ho
...
// COMPONENT: Navbar (AcmeHero) — Used across all pages, not a route itself
