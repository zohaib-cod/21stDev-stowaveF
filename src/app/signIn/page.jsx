...
//     try {
//       // ====== REAL-TIME LIVE LOGIN PIPELINE CONNECTION ======
...
//       // 🟢 AAPKI LIB UTILITY FILE KE MUTABIQ EXACT MAPPING STORAGE KEY "auth_user"
//       if (data.user) {
//         localStorage.setItem("auth_user", JSON.stringify(data.user));
        
//         // 🟢 NOTIFICATION BROADCAST EVENT NAME MUST BE "auth-changed" (D KE SATH)
