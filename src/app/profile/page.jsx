...
//   useEffect(() => {
//     // 🟢 Direct capture from your custom "auth_user" storage key grid
//     const rawData = localStorage.getItem("auth_user");
...
//   const handleLogout = () => {
//     // 🟢 Direct manual clear without external file utility dependencies
//     localStorage.removeItem("auth_user");
    
//     // Dispatches standard event trigger to alert navbar/header hooks instantly
